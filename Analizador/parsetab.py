...
_lr_productions = [
  ...
  ('parametros -> <empty>','parametros',0,'p_parametros','Gramatica.py',291),
  ('acceso -> PUBLICO','acceso',1,'p_accceso','Gramatica.py',295),
  ('acceso -> <empty>','acceso',0,'p_accceso','Gramatica.py',296),
  ('tipo_funcion -> RESTA MAYOR tipo_datos','tipo_funcion',3,'p_tipo_funcion','Gramatica.py',304),
  ('tipo_funcion -> RESTA MAYOR VECTOR MENOR tipo_datos MAYOR','tipo_funcion',6,'p_tipo_funcion','Gramatica.py',305),
  ('tipo_funcion -> <empty>','tipo_funcion',0,'p_tipo_funcion','Gramatica.py',306),
  ('declaracion -> LET mutable ID tipado PYC','declaracion',5,'p_declaracion','Gramatica.py',315),
  ('declaracion -> LET mutable ID tipado IGUAL expresiones PYC','declaracion',7,'p_declaracion','Gramatica.py',316),
  ('asignacion -> ID IGUAL expresiones PYC','asignacion',4,'p_asignacio','Gramatica.py',326),
  ('mutable -> MUT','mutable',1,'p_mutable','Gramatica.py',332),
  ('mutable -> <empty>','mutable',0,'p_mutable','Gramatica.py',333),
  ('tipado -> DP tipo_datos','tipado',2,'p_tipado','Gramatica.py',342),
  ('tipado -> <empty>','tipado',0,'p_tipado','Gramatica.py',343),
  ('tipo_datos -> TIPOINT','tipo_datos',1,'p_tipo_datos','Gramatica.py',351),
  ('tipo_datos -> TIPOFLOAT','tipo_datos',1,'p_tipo_datos','Gramatica.py',352),
  ('tipo_datos -> TIPOCHAR','tipo_datos',1,'p_tipo_datos','Gramatica.py',353),
  ('tipo_datos -> TIPOSTRING','tipo_datos',1,'p_tipo_datos','Gramatica.py',354),
  ('tipo_datos -> DIRSTRING','tipo_datos',1,'p_tipo_datos','Gramatica.py',355),
  ('tipo_datos -> TIPOBOOL','tipo_datos',1,'p_tipo_datos','Gramatica.py',356),
  ('impresiones -> PRINTLN PI CADENA PD PYC','impresiones',5,'p_instruccion_imprimir','Gramatica.py',378),
  ('impresiones -> PRINT PI CADENA PD PYC','impresiones',5,'p_instruccion_imprimir','Gramatica.py',379),
  ('impresiones -> PRINTLN PI CADENA COMA impresion_valores PD PYC','impresiones',7,'p_instruccion_imprimir','Gramatica.py',380),
  ('impresiones -> PRINT PI CADENA COMA impresion_valores PD PYC','impresiones',7,'p_instruccion_imprimir','Gramatica.py',381),
  ('impresion_valores -> impresion_valores COMA expresiones','impresion_valores',3,'p_imprimir_lista_valores','Gramatica.py',406),
  ('impresion_valores -> expresiones','impresion_valores',1,'p_imprimir_lista_valores','Gramatica.py',407),
  ('expresiones -> RESTA expresiones','expresiones',2,'p_expresiones','Gramatica.py',418),
  ('expresiones -> expresiones SUMA expresiones','expresiones',3,'p_expresiones','Gramatica.py',419),
  ('expresiones -> expresiones RESTA expresiones','expresiones',3,'p_expresiones','Gramatica.py',420),
  ('expresiones -> expresiones MULTI expresiones','expresiones',3,'p_expresiones','Gramatica.py',421),
  ('expresiones -> expresiones DIVI expresiones','expresiones',3,'p_expresiones','Gramatica.py',422),
  ('expresiones -> expresiones MODULO expresiones','expresiones',3,'p_expresiones','Gramatica.py',423),
  ('expresiones -> POWF PI expresiones COMA expresiones PD','expresiones',6,'p_expresiones','Gramatica.py',424),
  ('expresiones -> POW PI expresiones COMA expresiones PD','expresiones',6,'p_expresiones','Gramatica.py',425),
  ('expresiones -> expresiones MAYORIGUAL expresiones','expresiones',3,'p_expresiones','Gramatica.py',426),
  ('expresiones -> expresiones MAYOR expresiones','expresiones',3,'p_expresiones','Gramatica.py',427),
  ('expresiones -> expresiones MENORIGUAL expresiones','expresiones',3,'p_expresiones','Gramatica.py',428),
  ('expresiones -> expresiones MENOR expresiones','expresiones',3,'p_expresiones','Gramatica.py',429),
  ('expresiones -> expresiones IGUALDAD expresiones','expresiones',3,'p_expresiones','Gramatica.py',430),
  ('expresiones -> expresiones DESIGUALDAD expresiones','expresiones',3,'p_expresiones','Gramatica.py',431),
  ('expresiones -> PI expresiones PD','expresiones',3,'p_expresiones','Gramatica.py',432),
  ('expresiones -> ID','expresiones',1,'p_expresiones','Gramatica.py',433),
  ('expresiones -> ENTERO','expresiones',1,'p_expresiones','Gramatica.py',434),
  ('expresiones -> CADENA tipo_string','expresiones',2,'p_expresiones','Gramatica.py',435),
  ('expresiones -> FLOAT','expresiones',1,'p_expresiones','Gramatica.py',436),
  ('expresiones -> CADENA','expresiones',1,'p_expresiones','Gramatica.py',437),
  ('expresiones -> TRUE','expresiones',1,'p_expresiones','Gramatica.py',438),
  ('expresiones -> FALSE','expresiones',1,'p_expresiones','Gramatica.py',439),
  ('tipo_string -> TOOWNED','tipo_string',1,'p_tipo_string','Gramatica.py',500),
  ('tipo_string -> TOSTRING','tipo_string',1,'p_tipo_string','Gramatica.py',501),
]
